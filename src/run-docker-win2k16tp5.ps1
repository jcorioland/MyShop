...
docker run -d -p 80:5004 -e SHOP_FRONT_PORT=5004 -e SHOP_PRODUCTS_API_URL=http://docker112.northeurope.cloudapp.azure.com:5001 -e SHOP_RATINGS_API_URL=http://docker112.northeurope.cloudapp.azure.com:5002 -e SHOP_RECOMMANDATIONS_API_URL=http://docker112.northeurope.cloudapp.azure.com:5003 jcorioland/shop-front:win2k16tp5